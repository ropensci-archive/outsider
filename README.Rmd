...
outsider::module_uninstall(repo = 'dombennett/om..hello.world..1.0')
```
...
avlbl <- outsider::available()
pkgnms <- vapply(X = rownames(avlbl), FUN = outsider::.repo_to_pkgnm,
