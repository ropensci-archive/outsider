...
without the need to leave the R environment. Is there a command-line program
that is not available through `outsider` that you wish was? Well, you can create
your own module! If you can install the program on your own machine and have
